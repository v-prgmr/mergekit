    ...
    def objective(trial):
        for i in merge_config.models:
            for parameter_key, value in i.parameters.items():
                ...
                value.value = trial.suggest_uniform(key, 0.0, 1.0)
...
if __name__ == "__main__":
    ...
    objective = create_objective(multiline_yaml_template)
